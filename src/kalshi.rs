...
impl KalshiConfig {
    ...
    pub fn sign(&self, message: &str) -> Result<String> {
        ...
        tracing::info!("[KALSHI-AUTH] Signing: '{}', key_size={}, salt_len={}", message, key_size_bytes, max_salt_len);
        ...
        tracing::info!("[KALSHI-AUTH] Signature length: {}, first 30 chars: {}", sig_b64.len(), &sig_b64[..30.min(sig_b64.len())]);
        Ok(sig_b64)
    }
}
